...
| Class | Description |
| ------ | ------ |
| [AlphaBehavior](classes/AlphaBehavior.md) | Behavior which manages particle alpha over their lifetime. |
...
| [EmitterBehavior](classes/EmitterBehavior.md) | Abstract behavior class which all behaviors inherit from. |
...
| ------ | ------ |
| [InitBehavior](interfaces/InitBehavior.md) | Interface for behaviors which initialize particles. |
| [UpdateBehavior](interfaces/UpdateBehavior.md) | Interface for behaviors which update particles. |
