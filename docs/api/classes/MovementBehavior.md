...
- [`EmitterBehavior`](EmitterBehavior.md)\<[`MovementBehaviorConfig`](../type-aliases/MovementBehaviorConfig.md)\>

## Implements

- [`InitBehavior`](../interfaces/InitBehavior.md)\<[`MovementBehaviorConfig`](../type-aliases/MovementBehaviorConfig.md)\>
- [`UpdateBehavior`](../interfaces/UpdateBehavior.md)\<[`MovementBehaviorConfig`](../type-aliases/MovementBehaviorConfig.md)\>
...
```ts
new MovementBehavior(emitter): MovementBehavior;
```
...
| Parameter | Type                                                                  | Description             |
| --------- | --------------------------------------------------------------------- | ----------------------- |
| `config`  | [`MovementBehaviorConfig`](../type-aliases/MovementBehaviorConfig.md) | Behavior configuration. |
...
```ts
getConfig(): MovementBehaviorConfig;
```
...
[`MovementBehaviorConfig`](../type-aliases/MovementBehaviorConfig.md)
